...
function optimum_MMN_nodir(base_frequency,portoutput)
...
deviants = [];
deviants = (repmat(2:7,1,deviant_multiplier))'; %make deviant sequence 4 deviants * n but 2 types (freq and intensity) are split into up and down
%% Need 2*4 & 5
deviants = [deviants;ones(deviant_multiplier,1)*4;ones(deviant_multiplier,1)*7]; %additional 4 and 5 which are gap and duration
...
beeps = [[standard;standard] [lofreq_deviant;lofreq_deviant] [hifreq_deviant;hifreq_deviant] [gap_deviant;gap_deviant]...
    [lovol_deviant;lovol_deviant] [hivol_deviant;hivol_deviant] [dur_deviant;dur_deviant]];
